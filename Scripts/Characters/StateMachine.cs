...
public partial class StateMachine : Node
{
    ...
    {
        // send notification of the current state 
        _currentState.Notification(NotificationConsts.ENTER_STATE);
    }


    /// <summary>
    /// Loop through the states array and change the current state from the previouse to the new state<br/>
    ...
    public void SwitchState<T>()
    {
        ...
        if (newState != null)
        {
            // Before changing to the new state disable the previouse one
